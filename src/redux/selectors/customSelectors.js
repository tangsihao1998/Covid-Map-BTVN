export const getDataPatient = state => state.infoMap.patientData;
export const getCurrentPatient = state => state.infoMap.currentPatient;
export const getTimeNow = state => state.infoMap.timeNow;
